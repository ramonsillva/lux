...
config :lux_app,
  ecto_repos: [LuxApp.Repo],
  generators: [timestamp_type: :utc_datetime]

# Configure Flop to use LuxApp.Repo
config :flop, repo: LuxApp.Repo
...
config :lux_app, LuxAppWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: LuxAppWeb.ErrorHTML, json: LuxAppWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: LuxApp.PubSub,
...
config :lux_app, LuxApp.Mailer, adapter: Swoosh.Adapters.Local
